  ...
  return (
    <footer id="contact" className="footer">
      <div className="footer-container">
        <div className="footer-content-container">
          ...
          <div className="social-links">
            <a href="https://www.linkedin.com/in/razbracha" target="_blank" rel="noopener noreferrer">
              <img alt="LinkedIn" className="linkedin-image" src="/pictures/linkedin.svg" />
            </a>
            <a href="https://www.github.com/RazBracha" target="_blank" rel="noopener noreferrer">
              <img alt="GitHub" className="github-image" src="/pictures/github.svg" />
            </a>
            <a href="https://www.facebook.com/raz.bracha.7" target="_blank" rel="noopener noreferrer">
              <img alt="Facebook" className="facebook-image" src="/pictures/facebook.svg" />
            </a> 
        ...
        <img alt="Raz Bracha" className="footer-image" src="/pictures/raz-bracha.svg" />
      </div>
    </footer>
  );
}
